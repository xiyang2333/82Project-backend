 ...
 *
 * @author Jingxian Hu, Zhongke Tan, Meng
 */
...
public class InviteAssessorServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		int markerId = jsonReceive.getIntValue("markerId");
...
//						.getLecturerName(projectId);
//				String assessorName = dbFunction
//						.getMarkerName(markerId);
...
//		}
		...
		jsonSend.put("markerName", markerName);
